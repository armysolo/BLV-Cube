...
; This is not for a standard BLV Cube. This is for my highly customized triple z independent leveling with kinematic mounting, metal kit, Duet 3, Raspberry Pi 4, liquid cooled mosquito, Orbiter v1.5, Duet Tool Board, 24v main PSU, 5v PSU to provide 5v power to PS_ON. This isn't a cookie cutter config. It is meant to help you build or troubleshoot your config.
; 
; ================= General preferences ===================
...
M950 H0 C"0.out1" T0                                 		; create bed heater output on 0.out1 and map it to sensor 0
M950 H1 C"0.out2" T1                                 		; create nozzle heater output on 0.out2 and map it to sensor 1
...
M950 F1 C"0.out7";	Q25000									; create fan 1 on pin 0.out7 and set its frequency
...
M575 P2 B57600 S1                                  			; enable support for BLV NeoPixels
M911 S10 R11 P"M913 X0 Y0 G91 M83 G1 Z3 E-5 F1000" 			; set voltage thresholds and actions to run on power loss
;M574 S1 P"^!0.io7.in"               						; Define Emergency endstop - emergency stop switch condition
M950 J1 C"0.io4.in"											; Create GPIO pin for On button wired NO
...
;0.io7.out 		- NC
;0.io8.out 		- NC
;pson 			- Power on 5v relay wired for SBC always on and Duet 3 in standby
;0.spi.cs0 		- NC
