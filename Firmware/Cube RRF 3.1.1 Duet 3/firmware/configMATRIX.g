...
;
; generated by RepRapFirmware Configuration Tool v3.2.0 on Sat Jan 11 2021 20:25:37 GMT-0500 (Central Daylight Time)
...
; Drives
M569 P0.0 S1                                       ; physical drive 0.0 goes backwards-Extruder
...
M671 X-30:334:334 Y167.7:298:43.8 S10	   			; leadscrews at left front, right rear and right Front -28:337:337 Y155:279:27
M350 X32 Y32 Z16 E16 I1                            ; configure microstepping with interpolation
M92 X200.00 Y200.00 Z400.00 E332.08                ; set steps per mm -Black BMG Extruder
M203 X15000 Y15000 Z800 E20000                   ; Set maximum speeds (mm/min) mm per minute/60=mm per second
M201 X3000 Y3000 Z100 E4000			   				; Set accelerations (mm/s^2)
M906 X1600 Y1600 Z1600 E960 I30                   ; Set motor currents (mA) and motor idle factor in per cent
M84 S120                                             ; Disable motor idle current reduction
M566 X900.00 Y900.00 Z150.00 E1200.00 ; Set maximum instantaneous speed changes (mm/min)

; Axis Limits
M208 X-42 Y-24 Z0 S1                                   ; set axis minima
M208 X300 Y300 Z445 S0                             ; set axis maxima

; Endstops
M574 X1 S1 P"io2.in"                              ; configure active-high endstop for high end on X via pin i01.in
...
G31 P500 X12.9 Y61.5 Z.890                           	; set Z probe trigger value, offset and trigger height
M557 X65:328 Y21:291 S67.5                           ; define mesh grid

; Heaters
M308 S0 P"temp0" Y"thermistor" A"Bed" T100000 B4725 C0.0000000706             ; configure sensor 0 as thermistor on pin temp0
M308 S1 P"temp1" Y"thermistor" A"Hotend" T107537 B4725 C7.06e-8               ; configure sensor 1 as thermistor on pin temp1-Matrix
...
M307 H0 R0.148 C1375.8 D15.30 S1.00					;Set PID for bed heater POST RRF 3.2.3 beta
M140 H0                                            ; map heated bed to heater 0
M143 H0 S100                                       ; set temperature limit for heater 0 to 100C
M307 H1 R2.022 C323.7 D9.45 S1.00 V24.4		 		; Set PID for Hotend .4Bmm nozzle POST RRF 3.2.3 beta
